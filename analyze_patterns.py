...
def main():
    ...
    raw_web_path = os.path.join(data_dir, "raw_website_data.txt")
    clean_web_path = os.path.join(data_dir, "clean_website_data.txt")
    ...
    # Analyze PDF data
    raw_pdf_path = os.path.join(data_dir, "raw_pdf_data.txt")
    clean_pdf_path = os.path.join(data_dir, "clean_pdf_data.txt")
