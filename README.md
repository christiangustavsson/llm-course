...
5. `python tokenize_fineweb.py`, note that this will take some time. **OR**, for a powerful computer, `python tokenize_fineweb_parallell.py --workers 4 --chunk-size 5000` is also available, arguments can be changed depending on system performance. 
